...
% ======================================================================
verbosity = 1;
meshdir = '../../Documents/MATLAB/meshes/';       % example mesh repository
...
tau = 1e-5;                             % regularisation parameter
beta = 0.0001;                            % TV regularisation parameter
tolCG = 1e-6;                           % Gauss-Newton convergence criterion
resetCG = 40 ;                           % PCG reset interval
